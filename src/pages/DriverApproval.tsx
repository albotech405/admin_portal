  ...
  return (
    <div className="space-y-6">
                    ...
                    <div key={doc.id} className="rounded-xl border border-gray-200 overflow-hidden">
                      ...
                      >
                        <div className="flex items-center gap-3">
                          <span className="font-medium text-gray-800">{formatDocType(doc.document_type)}</span>
      ...
      <Modal
        ...
        onConfirm={
          isApprovalQueueDriver ? handleReject : handleSuspend
        }
        confirmText={
          isApprovalQueueDriver ? 'Reject' : 'Suspend'
        }
        confirmVariant={
          isApprovalQueueDriver ? 'danger' : 'warning'
        }
